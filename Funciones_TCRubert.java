...
public class Funciones_TC {
    ...
    public static void main(String[] args) {
        ...
        // inyectiva: todo elemento de A tiene una imagen diferente 
        //            que pertenece al grupo B
        System.out.println("---   Inyectiva   ---");
        System.out.println(inyectiva(w));
        // sobreyectiva: todo elemento de B es imagen de algim elemento del A
        System.out.println("--- Sobreyectiva  ---");
        System.out.println(sobreyectiva(w));
        // biyectiva: que cumple las propiedades anteriores
        System.out.println("---   Biyectiva   ---");
        System.out.println(biyectiva1(w));
        System.out.println(biyectiva2(w));
        System.out.println(biyectiva3(w));
        ...
        do{
            ...
            if (validarfuncion(w)){
                ...
                System.out.println("1 \t\t\t\t\t=\t"+sobreyectiva(w));
...
// ========================== tipos de función =============================
    ...
    public static boolean biyectiva3(int m[][]){
        int inversa[][] = inversa(m);
        return validarfuncion(inversa);
    }
